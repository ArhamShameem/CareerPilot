...
CREATE TYPE "public"."job_listings_location_interval" AS ENUM('in-office', 'hourly', 'yearly');--> statement-breakpoint
...
CREATE TABLE "job_listings" (
	...
	"locationRequirement" "job_listings_location_interval" NOT NULL,
